...
const en = {
  seo: {
    title: 'CHOLO — Open App Store for Verified Software',
  ...
  nav: { primary: 'Primary navigation', home: 'CHOLO home', search: 'Search apps', searchPlaceholder: 'SEARCH APPS...', openSearch: 'Open search' },
  footer: { tagline: 'Our Open App Store' },
  accessibility: { skip: 'Skip to main content', main: 'Main content' },
  home: {
    badge: 'HUMANS SANDBOX', title: 'CHOLO is the open App Store for everyone',
    ...
    loading: 'Loading apps from the public app database...', what: 'What CHOLO does', whatTitle: 'Discovery, coordination, and funding in one place.',
    whatLead: 'CHOLO maps high-integrity open-source software with app profiles, reviews, grants, and milestone accountability anchored by the Bitcoin App Registry.',
    ecosystemPillars: [
    ...
    faqBadge: 'Helpful answers', faqTitle: 'Frequently asked questions', faqLead: "Everything you need to know about CHOLO. Can't find your answer? Start with the docs or explore the app registry.",
    faqItems: [
      { question: 'Is CHOLO free to use?', answer: 'Yes. Browsing apps, reading profiles, and exploring public metadata are free. Funding and app-specific services may involve separate payment flows set by each project.' },
      { question: 'What kinds of apps are listed on CHOLO?', answer: 'CHOLO focuses on open-source Bitcoin apps, privacy tools, safe AI projects, wallets, infrastructure, developer tools, and other high-integrity software in the sovereign technology ecosystem.' },
      ...
      { question: 'How does funding work?', answer: 'CHOLO is designed to make funding context easier to understand through public project details, milestones, and delivery signals before support moves to a project.' },
      ...
      { question: 'Who is CHOLO for?', answer: 'CHOLO is for users looking for trustworthy software, builders publishing open-source projects, funders supporting public goods, and communities coordinating around useful tools.' },
    ...
    ctaEyebrow: 'Explore the sovereign software commons', ctaTitle: 'Find and support verified open-source software.', ctaLead: 'Use CHOLO to move from scattered links to readable app profiles: metadata, source code, milestones, reviews, and funding context together.'
  }
};

const es: typeof en = {
  seo: {
    title: 'CHOLO — Tienda abierta de software verificado',
  ...
  nav: { primary: 'Navegación principal', home: 'Inicio de CHOLO', search: 'Buscar aplicaciones', searchPlaceholder: 'BUSCAR APLICACIONES...', openSearch: 'Abrir búsqueda' },
  ...
  home: {
    ...
    what: 'Qué hace CHOLO', whatTitle: 'Descubrimiento, coordinación y financiamiento en un solo lugar.', whatLead: 'CHOLO organiza software de código abierto de alta integridad con perfiles, reseñas, subvenciones e hitos verificables anclados por el Bitcoin App Registry.',
    ecosystemPillars: [
    ...
    faqBadge: 'Respuestas útiles', faqTitle: 'Preguntas frecuentes', faqLead: 'Todo lo que necesitas saber sobre CHOLO. ¿No encuentras tu respuesta? Consulta la documentación o explora el registro.',
    faqItems: [
      { question: '¿CHOLO es gratis?', answer: 'Sí. Explorar aplicaciones, leer perfiles y consultar metadatos públicos es gratis. El financiamiento y los servicios específicos de cada aplicación pueden incluir pagos definidos por cada proyecto.' },
      { question: '¿Qué tipos de aplicaciones aparecen en CHOLO?', answer: 'CHOLO se centra en aplicaciones Bitcoin de código abierto, herramientas de privacidad, proyectos de IA segura, billeteras, infraestructura, herramientas para desarrolladores y otro software confiable del ecosistema de tecnología soberana.' },
      ...
      { question: '¿Cómo funciona el financiamiento?', answer: 'CHOLO facilita la comprensión del financiamiento mediante detalles públicos del proyecto, hitos y señales de entrega antes de que el apoyo llegue al proyecto.' },
      ...
      { question: '¿Para quién es CHOLO?', answer: 'CHOLO es para usuarios que buscan software confiable, creadores que publican proyectos de código abierto, financiadores de bienes públicos y comunidades que coordinan herramientas útiles.' },
...
const pt: typeof en = {
  seo: {
    title: 'CHOLO — Loja aberta de software verificado',
  ...
  nav: { primary: 'Navegação principal', home: 'Início da CHOLO', search: 'Buscar aplicativos', searchPlaceholder: 'BUSCAR APLICATIVOS...', openSearch: 'Abrir busca' },
  footer: { tagline: 'Nossa loja aberta de aplicativos' }, accessibility: { skip: 'Ir para o conteúdo principal', main: 'Conteúdo principal' },
  home: {
    badge: 'ESPAÇO PARA HUMANOS', title: 'CHOLO é a loja aberta de aplicativos para todos', lead: 'Descubra aplicativos úteis, compare informações confiáveis e apoie projetos abertamente, sem depender de intermediários ocultos.',
    ...
    what: 'O que a CHOLO faz', whatTitle: 'Descoberta, coordenação e financiamento em um só lugar.', whatLead: 'A CHOLO organiza software de código aberto de alta integridade com perfis, avaliações, subsídios e marcos verificáveis ancorados pelo Bitcoin App Registry.',
    ecosystemPillars: [
    ...
    faqBadge: 'Respostas úteis', faqTitle: 'Perguntas frequentes', faqLead: 'Tudo o que você precisa saber sobre a CHOLO. Não encontrou sua resposta? Consulte a documentação ou explore o registro.',
    faqItems: [
      { question: 'A CHOLO é gratuita?', answer: 'Sim. Explorar aplicativos, ler perfis e consultar metadados públicos é gratuito. O financiamento e os serviços específicos de cada aplicativo podem envolver pagamentos definidos por cada projeto.' },
      { question: 'Que tipos de aplicativos aparecem na CHOLO?', answer: 'A CHOLO se concentra em aplicativos Bitcoin de código aberto, ferramentas de privacidade, projetos de IA segura, carteiras, infraestrutura, ferramentas para desenvolvedores e outros softwares confiáveis do ecossistema de tecnologia soberana.' },
      ...
      { question: 'Como funciona o financiamento?', answer: 'A CHOLO facilita a compreensão do financiamento por meio de detalhes públicos do projeto, marcos e sinais de entrega antes que o apoio seja destinado ao projeto.' },
      ...
      { question: 'Para quem é a CHOLO?', answer: 'A CHOLO é para usuários que procuram software confiável, criadores que publicam projetos de código aberto, financiadores de bens públicos e comunidades que coordenam ferramentas úteis.' },
