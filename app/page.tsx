...
export default function Home() {
  ...
  return (
    <div className="min-h-screen dotted-grid-background  text-white">
      {/* Hero Section */}
          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex-1">
                <div className="w-12 h-12 bg-[#2563eb] rounded-full flex items-center justify-center text-white font-bold text-xl mb-4">
                  1
                </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of users who trust Kapu for their Bitcoin and Layer 2 needs.
          </p>
          <button
            className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold text-xl shadow-lg transition cursor-pointer select-none"
            onClick={() => setShowGetInModal(true)}
          >
            <Globe size={24} />
            Get Started Now
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex gap-4">
                <Link href="https://github.com/fabohax/kapu" target="_blank" className="text-gray-400 hover:text-white transition">
                ...
                <Link href="https://twitter.com/kapu" target="_blank" className="text-gray-400 hover:text-white transition">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 Kapu Wallet. Open source software licensed under GNU License.
            </div>
